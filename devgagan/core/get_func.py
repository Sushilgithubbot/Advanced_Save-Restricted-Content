...
def get_user_rename_preference(user_id):
    # Retrieve the user's custom renaming tag if set, or default to 'TEAM SK'
    return user_rename_preferences.get(str(user_id), 'TEAM SK')
...
async def settings_command(event):
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/personalSKbot")]
    ]
